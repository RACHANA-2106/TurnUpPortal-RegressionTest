...
namespace TurnUpPortal_RegressionTest.Pages
{
    public class TMPage
    {
        public void createTimeRecord(IWebDriver driver)
        {
            ...
            //IWebElement typecodeDropdown = driver.FindElement(By.XPath("//*[@id=\"TimeMaterialEditForm\"]/div/div[1]/div/span[1]/span/span[2]/span[1]"));
            IWebElement typeCodeDropdown = driver.FindElement(By.XPath("//*[@id=\"TimeMaterialEditForm\"]/div/div[1]/div/span[1]/span/span[2]/span"));
            typeCodeDropdown.Click();

            Wait.WaitForElementToBeClicable(driver, "XPath","//*[@id=\"TypeCode_listbox\"]/li[2]", 10);
